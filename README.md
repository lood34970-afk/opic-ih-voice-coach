...
기본 피드백 읽기 모델은 `gpt-4o-mini-tts`, 기본 음성은 `nova`, 기본 속도는 `0.78`입니다. `OPENAI_TTS_MODEL`, `OPENAI_TTS_VOICE`, `OPENAI_TTS_SPEED`는 선택값이라 설정하지 않아도 됩니다.
